...
tf.app.flags.DEFINE_integer("epoch", 300, "Epoch num")
...
tf.app.flags.DEFINE_float("reg_rate", 1e-3, "Learning rate")
...
def main(_):
    ...
    if FLAGS.is_training:
        ...
        summary_visual_weights = tf.summary.image("visual_weights", model.visual_weights, max_outputs=FLAGS.num_class)
